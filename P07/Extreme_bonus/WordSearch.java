...
public class WordSearch {
    ...
    for (int threadId = 0; threadId < NUM_THREADS; threadId++) {
        ...
        int start = threadId * puzzlesPerThread;
        int end = (threadId == NUM_THREADS - 1) ? NUM_PUZZLES : (threadId + 1) * puzzlesPerThread;

        // Create and start the thread
        threads[threadId] = new Thread(() -> solve(threadId, start, end));
